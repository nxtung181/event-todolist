...
router.get('/test', AuthMiddleware.requireAuth, AuthMiddleware.checkAdmin, AdminController.Test)
router.get('/test1', AuthMiddleware.requireAuth, AuthMiddleware.checkAdmin, validate(list, {context: true}), AdminController.Test1)
